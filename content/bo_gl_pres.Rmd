...
title: "Pressure (GL)"
description: |
  Basic analysis of the pressure data from the Baltic Sea in situ NRT observations.
output:
...
# Common functions
r_func_path <- "./_func"
r_funcs <- c("libraries.Rmd", "common.Rmd", "common_bo_gl.Rmd", "var.Rmd")
...
src <- knitr::knit_expand(t_v_basic_info, df=df_filtered_name,
